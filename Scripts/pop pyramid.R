...
# AUTHOR:   M. Zendt | USAID
# PURPOSE:  pop pyramids  
# REF ID:    
# LICENSE:  MIT
# DATE:     2024-10-31
# UPDATED: 
...
table(df_subnat$fiscal_year)

subnat_2023 <- df_subnat %>% 
  filter(fiscal_year == 2023)

subnat_2024 <- df_subnat %>% 
...
prep_pop_pyramid(subnat_2023, "South Africa", "country") %>% viz_pop_pyramid()
si_save("Images/FY24 GH Portfolio Review/2023_UGA_pop_pyramid.png")

prep_pop_pyramid(df_subnat, "South Africa", "country") %>% viz_pop_pyramid()
